package com.spring.shelf.Beans;
...
public class S3Emulator {
    ...
    public S3Client initS3() throws URISyntaxException {
        return S3Client.builder().endpointOverride(new URI(localstackPath)).credentialsProvider(credentialsProvider).region(Region.EU_NORTH_1).build();
    }
}
